...
BUILD_DIR="/work/u4063895/builds/z0f_${SLURM_JOB_ID}"
mkdir -p "$BUILD_DIR"
cd "$BUILD_DIR"
...
RESULTS_DIR="/work/u4063895/results/reliability_layer1/phase3/phase3z_z0f/job_${SLURM_JOB_ID}"
mkdir -p "$RESULTS_DIR"
...
B0 = 0.8702
lines = open("/work/u4063895/results/reliability_layer1/phase3/phase3z_z0f/job_'"$SLURM_JOB_ID"'/z0f_parallel_sum32_profile.csv").readlines()
# simpler: use env var
import os
...
# Use proper path
CSV_PATH_FULL="/work/u4063895/results/reliability_layer1/phase3/phase3z_z0f/job_${SLURM_JOB_ID}/z0f_parallel_sum32_profile.csv"
python3 -c "
import csv, math
from collections import defaultdict
