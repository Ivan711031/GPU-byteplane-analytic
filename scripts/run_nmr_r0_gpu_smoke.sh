...
BUILD_DIR="/work/u4063895/builds/nmr_r0_${SLURM_JOB_ID}"
RESULTS_DIR="/home/u4063895/workspace/gpu-byteplane-reliability-nmr/results/reliability_layer1/phase3/nmr_rescue_r0/job_${SLURM_JOB_ID}"
