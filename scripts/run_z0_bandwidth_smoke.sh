...
gcc --version
# Build
BUILD_DIR="${WORK_DIR}/builds/z0_${SLURM_JOB_ID}"
mkdir -p "$BUILD_DIR"
cd "$BUILD_DIR"
...
if [ -d "$DATASET_DIR" ]; then
    ...
    DATASET_DIR="${WORK_DIR}/datasets/scientific/dev_buff_v2_scientific/cesm_atm_cloud/bfp-dec12"
    echo "Using CESM-ATM cloud (dev_buff_v2)"
fi
# Output
RESULTS_DIR="${WORK_DIR}/results/reliability_layer1/phase3/phase3z_z0/job_${SLURM_JOB_ID}"
mkdir -p "$RESULTS_DIR"
