...
SRC="/home/u4063895/workspace/gpu-byteplane-reliability-nmr/benchmarks/experiment4_filter_aggregate/z0c_crc_probe.cu"
TMPDIR="/work/u4063895/builds/z0c_${SLURM_JOB_ID}"
mkdir -p "$TMPDIR"
