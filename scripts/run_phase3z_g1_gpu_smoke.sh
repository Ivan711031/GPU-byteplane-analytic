...
BUILD_DIR="${WORK_DIR}/builds/g1_${SLURM_JOB_ID}"
RESULTS_DIR="${WORK_DIR}/results/reliability_layer1/phase3/phase3z_z1b/job_${SLURM_JOB_ID}"
LOCAL_RESULTS="${PROJ_DIR}/workspace/gpu-byteplane-reliability-nmr/results/reliability_layer1/phase3/phase3z_z1b/job_${SLURM_JOB_ID}"
